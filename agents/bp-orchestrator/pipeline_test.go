...
func TestOnlyHighAndCriticalAlertsGetADraft(t *testing.T) {
	...
	peers.alerts.Alerts = []models.Alert{
		models.NewAlert("alt_1", testBrandID, models.AlertSpike, models.SeverityLow, "spike:x:1", testNow),
		models.NewAlert("alt_2", testBrandID, models.AlertCrisis, models.SeverityCritical, "crisis:x:1", testNow),
		models.NewAlert("alt_3", testBrandID, models.AlertReviewBomb, models.SeverityHigh, "review_bomb:x:1", testNow),
		models.NewAlert("alt_4", testBrandID, models.AlertCompetitorMove, models.SeverityMedium, "competitor_move:x:1", testNow),
	}
