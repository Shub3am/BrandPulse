// main.go is bp-collector's process entry point and nothing else: telemetry,
// the pool, the card, serve. Every line of behaviour is in collector.go, and
